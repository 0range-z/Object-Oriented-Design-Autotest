...
def autotest(FILE_LIST, ROUND):
    ...
    for j in range(ROUND):
        ...
        dataMake(mode=mode, isStrong=isStrong)
        print("mode={} isStrong={}".format(mode, isStrong))
